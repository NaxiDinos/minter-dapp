const contractAddress = "0x6473A54a79ef61DCD7Be169C88018e4dcBB68AC7"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to Super Dinos NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Super Dinos NFT Project is a decentralized, open-source project that aims to create a fight VR game!;
